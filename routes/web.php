...
//        Route::post('/register','InternshipController@register')->name('admin.internship.register');
    ...
    //register
     ...
     //search
        Route::post('/search', 'RegisterServiceController@search')->name('admin.register_services.search');
     //Extend
        Route::GET('/{id}/extend', 'RegisterServiceController@extend')->name('admin.register_services.extend');
        Route::post('/storeextend', 'RegisterServiceController@storeextend')->name('admin.register_services.storeextend');
    });
    ...
    Route::prefix('/register_softs')->group(function(): void{
        ...
        //search
        Route::GET('/search', 'RegisterSoftController@action')->name('admin.register_softs.action');
        //Extend
        Route::GET('/{id}/extend', 'RegisterSoftController@extend')->name('admin.register_softs.extend');
        Route::post('/storeextend', 'RegisterSoftController@storeextend')->name('admin.register_softs.storeextend');
    ...
    Route::prefix('/order')->group(function(): void{
        ...
        Route::get('/searchsoft', 'OrderController@searchsoftware')->name('admin.order.searchsoftware');
        ...
        Route::get('/searchservices', 'OrderController@searchservices')->name('admin.order.searchservices');
    ...
    Route::prefix('/invoices')->group(function(): void{
        ...
        Route::get('/payment', 'InvoiceController@payment')->name('admin.invoices.payment');
