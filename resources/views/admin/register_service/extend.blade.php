                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 style="font-weight: bold; font-family: 'roboto'; font-size: 230%;">Chỉnh sửa dịch vụ</h3>
                            <form action="{{route('admin.register_services.storeextend')}}" method="post">
                                                ...
                                                <div >
                                                    ...
                                                    <div class="input-group">
                                                        <input class="form-control" id="start_date" name="start_date"
                                                               value="{{ date('Y-m-d\TH:i', strtotime($register_service->start_date)) }} "readonly type="text"/>
