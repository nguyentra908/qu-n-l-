                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <form action="{{route('admin.register_softs.storeextend')}}" method="post">
                                ...
                                <div class="panel panel-default">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <div class="col-xs-12 form-group ">
                                                    ...
                                                    <input type="datetime-local" class="form-control " readonly name="start_date"
                                                           value="{{isset($register_soft->start_date) ?
                                   date('Y-m-d\TH:i', strtotime($register_soft->start_date)) : ''}}">
                                                    <p class="help-block text-danger"></p>
                                   ...
                                   date('Y-m-d\TH:i', strtotime($register_soft->end_date)) : ''}}">
                                        ...
                                        <a href="{{ route('admin.register_softs.index') }}"
