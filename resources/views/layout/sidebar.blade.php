...
{{--                        </li>--}}
                        ...
                        <li class="{{ $request->segment(2) == 'register_softs' ? 'active active-sub' : '' }}">
                            <a href="{{route("admin.register_softs.create")}}" class="nav-link">
                                <i class="fa fa-gift"></i>
                                <p>
                                    Đăng ký phần mềm
                                </p>
...
{{--                    </a>--}}
{{--                    <ul class="nav nav-treeview " id="nav-item" style="background-color: rgb(47 45 45)">--}}
{{--                        <li class="nav-item {{ $request->segment(2) == 'register_softs' ? 'active active-sub' : '' }}">--}}
...
{{--                </li>--}}
                ...
                <li class="nav-item has-treeview ">
                    ...
                    <ul class="nav nav-treeview " id="nav-item" style="background-color: rgb(47 45 45)">
                        <li class="nav-item {{ $request->segment(2) == 'order' ? 'active active-sub' : '' }}">
                            <a href="{{route("admin.order.services")}}" class="nav-link">
                                <i class="fa fa-list"></i>
                                <p>Đơn hàng dịch vụ</p>
                            </a>
                        </li>
                        <li class="{{ $request->segment(2) == 'order' ? 'active active-sub' : '' }}">
                            <a href="{{route("admin.order.software")}}" class="nav-link">
                                <i class="fa fa-list"></i>
                                <p>
                                    Đơn hàng phần mềm
                                </p>
                ...
                <li class="nav-item has-treeview ">
                    ...
                    <ul class="nav nav-treeview " id="nav-item" style="background-color: rgb(47 45 45)">
                        <li class="nav-item {{ $request->segment(2) == 'register_softs' ? 'active active-sub' : '' }}">
                            <a href="{{route("admin.invoices.receipts")}}" class="nav-link">
                                <i class="fa fa-list"></i>
                                <p>Sổ quỹ</p>
                            </a>
                        </li>
                        ...
                        <li class="{{ $request->segment(2) == 'invoices' ? 'active active-sub' : '' }}">
                            <a href="{{route("admin.invoices.payment")}}" class="nav-link">
                                <i class="fa fa-gift"></i>
                                <p>
                                    Phiếu chi
                                </p>
